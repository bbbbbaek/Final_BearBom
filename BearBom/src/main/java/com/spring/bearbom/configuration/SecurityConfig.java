...
import com.spring.bearbom.jwt.JwtAuthenticationFilter;
...
//	private CustomOAuth2UserService customOAuth2UserService;
	...
	public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
		http.cors() //cors는 WebMvcConfig로 설정했으므로 따로 지정안함
			...
			.authorizeRequests().antMatchers("/", "/api/member/**", "/api/user/*","/api/guide/*" , "/api/helpdesk/**", "/oauth/**","/upload/*", "/api/course/getCourseList","/api/course/getCommonCodeList", "/api/course/searchCourse","/api/main/**","/api/course/getReviewList","/api/course/getCourse","/api/course/getCourseFile").permitAll()
