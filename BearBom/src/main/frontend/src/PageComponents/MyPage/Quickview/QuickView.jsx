...
const QuickView = ({ type, widgetData }) => {
  ...
  const [liked] = Object.values(Object.values(widgetData)[0][0]);
  const [opened] = Object.values(Object.values(widgetData)[1][0]);
  const [taken] = Object.values(Object.values(widgetData)[2][0]);
